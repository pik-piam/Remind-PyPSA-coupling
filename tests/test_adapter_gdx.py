"""Tests for RemindGdxAdapter's sparse-GDX-reading helpers."""
...
def test_fill_missing_with_zero_fills_only_modeled_technologies():
    ...
    out = RemindGdxAdapter._fill_missing_with_zero(
...
def test_fill_missing_with_zero_no_op_when_sparse_already_complete():
    ...
    out = RemindGdxAdapter._fill_missing_with_zero(sparse, modeled_techs, "VOM", "$/MWh")

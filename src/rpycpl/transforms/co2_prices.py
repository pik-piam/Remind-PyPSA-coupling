"""Extract and convert the REMIND CO2 price pathway.

Ported from PyPSA-Eur ``scripts/import_REMIND_co2price.py``. The transform is
name-agnostic: it takes an already-loaded frame with canonical columns
...
# Centralized in rpycpl.units (REMIND reports per tonne carbon; PyPSA wants per tonne CO2).
from rpycpl.units import TONNE_C_TO_TONNE_CO2

...
#: GDX backend reports carbon prices/intensities per tonne of *carbon*; PyPSA wants per tonne CO2.
TONNE_C_TO_TONNE_CO2 = MOLAR_MASS_C / MOLAR_MASS_CO2

#: Hours per year — GDX backend reports flows per year-average (e.g. TWa), PyPSA per MWh.
